...
/** Locked skeleton showcase — same plain body as the old head gallery. */
function lockedLozengeShowcase(): CharacterSpec {
  return {
    skin: "#f0c8a0",
    leadSide: "right",
    head: { shape: "lozenge", scale: 1 },
...
export const PRESETS: Record<PresetId, CharacterSpec> = {
  lozenge: lockedLozengeShowcase(),

  mage: {
    skin: "#e4a672",
    leadSide: "right",
    head: { shape: "lozenge", scale: 0.98 },
  ...
  /** Helm-ready square brow + jaw blocks; short cropped fringe under kettle. */
  knightNew: {
    skin: "#e4a672",
    leadSide: "right",
  ...
  /** Compact tough skull + hard brow; buzzed military crop. */
  soldierNew: {
    skin: "#c98a6a",
    leadSide: "right",
  ...
  /** Oversized forehead dome; wild red mohawk for lab chaos. */
  scientistNew: {
    skin: "#f0c8a0",
    leadSide: "right",
  ...
  /** Weather-lean skull; forest braid, no cap so skull reads. */
  rangerNew: {
    skin: "#d4a574",
    leadSide: "right",
