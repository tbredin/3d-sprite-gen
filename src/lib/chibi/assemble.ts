...
import type { CharacterSpec, HeadShape, PresetId } from "./types";
...
/** Shared body for head-gallery presets so skeleton differences read clearly. */
function headGallery(shape: HeadShape): CharacterSpec {
  return {
    skin: "#f0c8a0",
    leadSide: "right",
    head: { shape, scale: 1 },
